...
for curr_fold in range(0, fold):
    ...
    fold_size = datasets_alpha.shape[0] // fold
    indexes_list = [i for i in range(len(datasets_alpha))]
    ...
    batch_num_per_epoch = math.floor(alpha_train_x.shape[0] / batch_size) + 1
    # set test batch number per epoch
    accuracy_batch_size = batch_size
    train_accuracy_batch_num = batch_num_per_epoch
    test_accuracy_batch_num = math.floor(alpha_test_x.shape[0] / batch_size) + 1
