...
def file_name(file_dir="D:/CB/dreamer_project/result/total_result/"):
...
dataset_dir = "D:/CB/dreamer_project/dreamer_feature/DE_feature/DE_sub_"
###load training set
input_file = "%d"%sub
...
datasets_theta = datasets[:, 0:14].reshape(-1,input_height, input_width, input_channel_num)
datasets_alpha=datasets[:,14:28].reshape(-1,input_height, input_width, input_channel_num)
datasets_beta=datasets[:,28:42].reshape(-1,input_height, input_width, input_channel_num)
datasets_gamma=datasets[:,42:56].reshape(-1,input_height, input_width, input_channel_num)
...
print("acc:", mean_acc, "save path: D:/CB/dreamer_project/result/total_result/", save_file_name)
if save_file_name not in files:
    ...
    book.save("D:/CB/dreamer_project/result/total_result/" + save_file_name)

rexcel = open_workbook(
    "D:/CB/dreamer_project/result/total_result/" + save_file_name)  # 用wlrd提供的方法读取一个excel文件
...
excel.save("D:/CB/dreamer_project/result/total_result//" + save_file_name)
